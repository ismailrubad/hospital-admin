...
export const addZone = (name, district) => {
   return axios.post('http://3.6.216.223/admin/api/zone/add', {
      name,
      district
   })
};
...
export const editZone = (id, name, district) => {
   return axios.post('http://3.6.216.223/admin/api/zone/update', {
      id,
      name,
      district
   })
...
export const fetchZoneList = (currentPage = 1, limit = 5, sort = "name", sortOrder = 1, district, query) => {
   return axios.get('http://3.6.216.223/admin/api/zone', {
      params: {
         query,
         limit: limit,
         page: currentPage,
...
export const fetchZoneDetails = (id) => {
   return axios.get(`http://3.6.216.223/admin/api/zone/${id}`, {
      params: {
         resolveDistrict: 1
      }
   })
